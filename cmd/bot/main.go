...
import (
	...
	"gitlab.ozon.dev/egor.linkinked/kartashov-egor/internal/reports/grpc/server"
	"gitlab.ozon.dev/egor.linkinked/kartashov-egor/internal/reports/kafka"
	"gitlab.ozon.dev/egor.linkinked/kartashov-egor/internal/reports/kafka/producer"
